...
PROMPTS = {
    ...
    "BLURB": "Your job is to find commonalities between these ideas and generate a short paragraph of about common themes."
}
...
if __name__ == "__main__":
    ...
    if "prune" not in sys.argv and "summarize" not in sys.argv and "sort" not in sys.argv and "blurb" not in sys.argv:
    ...
    if "prune" in sys.argv:
        ...
        for record in records:
            print("Wait, I don't think I need this")
